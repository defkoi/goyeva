...
const (
	 ...
	 *
	 * var struct = (Prototype) { elem, [key] = value };
	 * var struct = { elem, [key] = value };
	 *
	 * (Prototype) { elem, value = [key] } = struct;
	 * { elem, value = [key] } = struct;
	 *
	 * var (Prototype) { elem, value = [key] } = struct;
	 * var { elem, value = [key] } = struct;
	 *
	 * (Prototype) struct; <- set prototype nud
	 */
